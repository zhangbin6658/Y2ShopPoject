		...
		<div class="pageTop">
			<div class="page">
				<img src="${pageContext.request.contextPath}/statics/images/coin02.png" /><span><a href="${pageContext.request.contextPath}/admin/main.html">首页</a><!-- &nbsp;-&nbsp;<a
					href="#">公共管理</a>&nbsp; -->-</span>&nbsp;<a href="${pageContext.request.contextPath}/admin/commentlist.html">评论管理</a>
			</div>
		</div>
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="200px" class="tdColor">名称</td>
							<td width="240px" class="tdColor">评论内容</td>
							<td width="220px" class="tdColor">评论时间</td>
							<!-- <td width="130px" class="tdColor">操作</td> -->
						</tr>
						
						<c:forEach items="${commentaryList}" var="commentaryList">
							...
							<td>${commentaryList.ID}</td> --%>
							
							<td><img alt="" width="80px" height="50px"
									src="${pageContext.request.contextPath}/statics/${commentaryList.pimage}"></td>
									
							<td>${commentaryList.pname}</td>
							<td>${commentaryList.commentaryContent}</td>
							<td><fmt:formatDate value="${commentaryList.commentaryTime}" type="both"/></td>
