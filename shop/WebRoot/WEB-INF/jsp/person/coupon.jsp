...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/statics/css/cpstyle.css" rel="stylesheet" type="text/css">
									...
									<div class="coupon-items">
											...
											<div class="coupon-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<span><img src="${pageContext.request.contextPath}/statics/images/gift_stamp_31.png"/></span>
													</div>
												</li>												
											</div>
										</div>
										<div class="coupon-item coupon-item-yf">
											<div class="coupon-list">
												...
												<li class="td td-usestatus ">
													<div class="item-usestatus ">
														<span><img src="${pageContext.request.contextPath}/statics/images/gift_stamp_21.png"/></span>
													</div>
												</li>
											</div>
										</div>
