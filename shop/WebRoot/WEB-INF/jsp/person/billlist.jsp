...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/statics/css/bilstyle.css" rel="stylesheet" type="text/css">
				...
				<div class="main-wrap">
					...
					<table width="100%">
						...
						<tbody>
							<tr>
								<td class="img">
									<i><img src="${pageContext.request.contextPath}/statics/images/songzi.jpg"></i>
								</td>
								<td class="time">
									<p> 2016-01-28
									</p>
