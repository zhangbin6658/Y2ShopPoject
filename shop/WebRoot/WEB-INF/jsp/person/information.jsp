...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/statics/css/infstyle.css" rel="stylesheet" type="text/css">
					...
					<div class="user-info">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								...
								<img class="am-circle am-img-thumbnail" src="${pageContext.request.contextPath}/statics/images/getAvatar.do.jpg" alt="" />
							</div>
							...
							<form action="#" class="am-form am-form-horizontal">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" name="nickName" placeholder="昵称">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="password" id="oldPassword" name="oldName" placeholder="请输入原密码">
                                         
									</div>
								</div>
								<div class="am-form-group">
									<label for="user-name" class="am-form-label">新密码</label>
									<div class="am-form-content">
								...
								<div class="am-form-group">
									<label for="user-name" class="am-form-label">新密码</label>
									<div class="am-form-content">
										<input type="password" id="newPassWords" name="newPassWords" placeholder="请再次输入新密码">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" name="phone" placeholder="请输入手机号" type="tel">
