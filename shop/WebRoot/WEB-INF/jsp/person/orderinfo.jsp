...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/statics/css/orstyle.css" rel="stylesheet" type="text/css">
						...
						<div class="order-infoaside">
							<div class="order-logistics">
								<a href="logistics.html">
									<div class="icon-log">
										<i><img src="${pageContext.request.contextPath}/statics/images/receive.png"></i>
									</div>
										...
										<div class="order-left">
											...
											<ul class="item-list">
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="${pageContext.request.contextPath}/statics/images/62988.jpg_80x80.jpg" class="itempic J_ItemImg">
														</a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
