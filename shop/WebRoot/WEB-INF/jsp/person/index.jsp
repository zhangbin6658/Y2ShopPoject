...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/statics/css/vipstyle.css" rel="stylesheet" type="text/css">
	...
	<body>
					...
					<div class="wrap-left">
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-baseinfo">
										<a class="m-pic" href="information.html">
											<img src="${pageContext.request.contextPath}/statics/images/getAvatar.do.jpg">
										</a>
										<div class="m-info">
								...
								<div class="wallet">
									...
									<p class="m-big squareS">
										<a href="#">
											<i><img src="${pageContext.request.contextPath}/statics/images/shopping.png"/></i>
											<span class="m-title">能购物</span>
										</a>
									</p>
									<p class="m-big squareA">
										<a href="#">
											<i><img src="${pageContext.request.contextPath}/statics/images/safe.png"/></i>
											<span class="m-title">够安全</span>
										</a>
									</p>
									<p class="m-big squareL">
										<a href="#">
											<i><img src="${pageContext.request.contextPath}/statics/images/profit.png"/></i>
							...
							<%-- div class="m-order">
								...
								<ul>
									<li><a href="order.html"><i><img src="${pageContext.request.contextPath}/statics/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.html"><i><img src="${pageContext.request.contextPath}/statics/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.html"><i><img src="${pageContext.request.contextPath}/statics/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.html"><i><img src="${pageContext.request.contextPath}/statics/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.html"><i><img src="${pageContext.request.contextPath}/statics/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
								<div class="orderContentBox">
									<div class="orderContent">
										<div class="orderContentpic">
											<div class="imgBox">
												<a href="orderinfo.html"><img src="${pageContext.request.contextPath}/statics/images/youzi.jpg"></a>
											</div>
										</div>
								...
								<div class="orderContentBox">
									<div class="orderContent">
										<div class="orderContentpic">
											<div class="imgBox">
												<a href="orderinfo.html"><img src="${pageContext.request.contextPath}/statics/images/heart.jpg"></a>
											</div>
										</div>
										<div class="detailContent">
							...
							<div class="user-squaredIcon">
								...
								<ul>
									...
									<a href="${pageContext.request.contextPath}/statics/home/home2.html">
								...
								<div class="twoTabModel credit">
									...
									<div class="Box">
										...
										<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
											<ul class="am-slides">
												<li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/333.jpg" /></a></li>
												<li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/222.jpg" /></a></li>
												<li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/111.jpg" /></a></li>
												<li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/333.jpg" /></a></li>
												<li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/222.jpg" /></a></li>
												<li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/111.jpg" /></a></li>
											</ul>
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#">
									<div class="face-img-panel">
										<img src="${pageContext.request.contextPath}/statics/images/imgsearch1.jpg" alt="">
									</div>
						...
						<div class="new-goods">
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#" target="_blank">
									<div >
										<img src="${pageContext.request.contextPath}/statics/images/666.jpg" alt="">
									</div>
                        ...
                        <div class="am-tabs-bd">
                            ...
                            <div data-tab-panel-0 class="am-tab-panel am-active">
                        		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
									<ul class="am-slides">
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${pageContext.request.contextPath}/statics/images/EZA27501.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${pageContext.request.contextPath}/statics/images/BxJk6.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${pageContext.request.contextPath}/statics/images/Hxcag60.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${pageContext.request.contextPath}/statics/images/youzi.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${pageContext.request.contextPath}/statics/images/EZA27501.jpg" /></a>
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="${pageContext.request.contextPath}/statics/home/home2.html"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="${pageContext.request.contextPath}/statics/home/sort.html"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="${pageContext.request.contextPath}/statics/home/shopcart.html"><i class="am-icon-shopping-basket"></i>购物车</a></li>
