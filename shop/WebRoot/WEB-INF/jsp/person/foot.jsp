...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/statics/css/footstyle.css" rel="stylesheet" type="text/css">
								...
								<div class="goods-pic">
									<div class="goods-pic-box">
										<a class="goods-pic-link" target="_blank" href="#" title="意大利费列罗进口食品巧克力零食24粒  进口巧克力食品">
											<img src="${pageContext.request.contextPath}/statics/images/TB1_pic.jpg_200x200.jpg" class="goods-img"></a>
									</div>
